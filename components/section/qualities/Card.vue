...
<template>
  <div class="qualities-card" :class="`qualities-card--${id}`">
    <CPicture
      src="/images/qualities/icons/gradient-horizontal.png"
      alt=""
      class="gradient"
      :class="`gradient--${id}`"
    />
